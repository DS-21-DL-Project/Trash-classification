...
---
## Introduction
<blockquote>제주의 클린 하우스 운영과 같이 쓰레기 분리 수거를 실시하는 지역에서는 분리 배출 전, 폐기물의 정확한 분류가 중요한 문제로 대두되고 있습니다. 또한 한국 전역에서는 생활 폐기물 발생량이 증가하는 추세이며, 분리 배출 오분류로 인한 경제적 손실 또한 증가하고 있습니다. </blockquote> 
